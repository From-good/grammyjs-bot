...
    }
    console.log(`[DEBUG] Attempting to reply to user ID: ${targetUserId}`); // 🔥 Добавленная строка для отладки

    if (!targetUserId || isNaN(targetUserId)) {
        console.error('[ERROR] Could not find a valid user ID to reply to.'); // 🔥 Добавленная строка для отладки
...
        return;
    }
    console.log(`[DEBUG] Received message from user ID: ${userId}`); // 🔥 Добавленная строка для отладки
